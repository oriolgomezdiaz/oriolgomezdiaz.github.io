...
* **M07 - Desenvolupament d'Interfícies:** JavaFX, Swing i Usabilitat.
* **M10 - Sistemes de Gestió Empresarial:** ERPs i Odoo.
* **Digitalització i Sistemes Informàtics.**
...
* **M02 - Gestió de Bases de Dades:** SQL i disseny relacional.
* **M10 - Administració de SGBD:** Seguretat, optimització i PL/SQL.

[👉 Veure recursos d'ASIX](/asix/){: .btn .btn--success}

### 🎓 Recerca i Projectes
Un espai on comparteixo la meva trajectòria acadèmica més enllà de l'aula:
* **TFM (Màster de Professorat):** Investigació sobre metodologies docents.
* **TFG (Grau):** Desenvolupament tècnic final de carrera.
